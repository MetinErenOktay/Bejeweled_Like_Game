...
public class leftThenRightDiagonalMath{
    public leftThenRightDiagonalMath(ArrayList<ArrayList<String>> gameGridListofLists, int x2, int y2, ArrayList<String> scoreList, ArrayList<String> totalScoreList){
        int x5 = 0;
